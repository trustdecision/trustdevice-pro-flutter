...
1. 调用 [获取License API](https://cn-support.trustdecision.com/reference/liveness-flutter#1获取license-api)，得到一个在时间有效期范围内的License。
2. 安装活体检测SDK Flutter插件，获取“livenessId”。
3. 调用 [获取结果 API](https://cn-support.trustdecision.com/reference/liveness-flutter#3获取结果-api)，传入第2步中获得的“livenessId”，传入第2步中获得的“liveness_id”，在活体检测过程完毕后获取最佳人脸自拍照（无论是真人或者是假人攻击场景），或在活体检测过程失败时接收详细原因。
